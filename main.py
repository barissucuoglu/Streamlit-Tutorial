...
st.header("Start of the Checkboz Section")
...
if button2:
    if like:
        st.write("Thank, I like it too.")
    else:
        st.write("I'm sorry. You have bad tastes.")

st.header("Start of the Radio Buttton Section")
...
user_text = st.text_input("What is your favorite movie", "Star Wars Ep. IV ")

if st.button("Text Button"):
    st.write(user_text)

user_num = st.number_input("What's you favorite number?")
